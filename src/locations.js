/**
 * Client-location options for the `location=` search param.
 *
 * Upwork accepts the plain display name, comma-separated for multiple
 * (`location=Americas,Europe`). Verified for all three tiers: regions,
 * subregions and individual countries each return disjoint result sets.
 */

export const REGIONS = ['Africa', 'Americas', 'Antarctica', 'Asia', 'Europe', 'Oceania'];
...
export const COUNTRIES = [
  ...
  'French Polynesia', 'French Southern and Antarctic Lands', 'Gabon', 'Gambia',
  ...
  'Lebanon', 'Lesotho', 'Liechtenstein', 'Lithuania', 'Luxembourg', 'Macao',
  ...
  'Reunion', 'Romania', 'Rwanda', 'Saint Barthelemy', 'Saint Helena',
  'Saint Kitts and Nevis', 'Saint Lucia', 'Saint Martin (French part)',
  'Saint Pierre and Miquelon', 'Saint Vincent and the Grenadines', 'Samoa',
  'San Marino', 'Sao Tome and Principe', 'Saudi Arabia', 'Senegal', 'Serbia',
  'Seychelles', 'Sierra Leone', 'Singapore', 'Sint Maarten (Dutch part)',
  'Slovakia', 'Slovenia', 'Solomon Islands', 'Somalia', 'South Africa',
  'South Korea', 'Spain', 'Sri Lanka', 'Suriname', 'Svalbard and Jan Mayen',
...
export const LOCATION_GROUPS = [
  ...
  { label: 'Subregions', items: SUBREGIONS },
